...
capture.output(
  pc1_test,
  file = "~/Desktop/DESeq2_plotPCA_PC1_stats.txt"
)

capture.output(
  pc2_test,
  file = "~/Desktop/DESeq2_plotPCA_PC2_stats.txt"
)
...
ggsave(
  filename = "~/Desktop/DESeq2_plotPCA_PC1_bar_TP-Caud_vs_Combination-Caud.pdf",
  plot = p_pc1,
  width = 4.5,
  height = 5
)
...
ggsave(
  filename = "~/Desktop/DESeq2_plotPCA_PC1_bar_TP-Caud_vs_Combination-Caud.png",
  plot = p_pc1,
  width = 4.5,
  height = 5,
  dpi = 300
...
ggsave(
  filename = "~/Desktop/DESeq2_plotPCA_PC2_bar_TP-Caud_vs_Combination-Caud.pdf",
  plot = p_pc2,
  width = 4.5,
  height = 5
)
...
ggsave(
  filename = "~/Desktop/DESeq2_plotPCA_PC2_bar_TP-Caud_vs_Combination-Caud.png",
  plot = p_pc2,
  width = 4.5,
  height = 5,
  dpi = 300
